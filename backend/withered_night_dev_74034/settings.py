"""
Django settings for withered_night_dev_74034 project.
...
ROOT_URLCONF = 'withered_night_dev_74034.urls'
...
WSGI_APPLICATION = 'withered_night_dev_74034.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "withered_night_dev_74034 API",
    "DESCRIPTION": "API documentation for withered_night_dev_74034 App",
    "VERSION": "v1",
}
